    ...
    showCompletionScreen() {
        ...
        const completionHTML = `
            <div class="completion-screen">
                ...
                <p>You've completed today's goal of ${this.dailyGoal} words.</p>
                <div class="stats">
                    <div class="stat">
                        <span class="stat-label">Words Practiced</span>
                        <span class="stat-value">${this.completedCount}</span>
                    </div>
                    <div class="stat">
                        <span class="stat-label">Daily Goal</span>
                        <span class="stat-value">${this.dailyGoal}</span>
                    </div>
                </div>
                <div class="actions">
                    <button id="continue-btn" class="secondary-btn">
                        Continue Anyway
                    </button>
        ...
        document.querySelector('.main-content').insertAdjacentHTML('beforeend', completionHTML);
