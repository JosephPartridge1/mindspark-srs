...
class LearningSession {
    ...
    showCompletionScreen() {
        // Sembunyikan elemen belajar
        document.querySelector('.word-section').style.opacity = '0.3';
        ...
        // Sisipkan setelah input area
        document.querySelector('.input-area').insertAdjacentHTML('afterend', message);
    }
