...
class LearningSession {
    ...
    continueSession() {
        ...
        if (completionScreen) completionScreen.remove();
    ...
    async saveAllAnswers() {
        console.log(`💾 Saving ${this.answers.length} answers to database...`);
        ...
        for (const [index, answer] of this.answers.entries()) {
            ...
            try {
                ...
                console.error(`    ❌ Failed to save answer ${index + 1}:`, error);
            }
        }
    }
}
...
// Session initialization is now handled in LearningSession constructor
